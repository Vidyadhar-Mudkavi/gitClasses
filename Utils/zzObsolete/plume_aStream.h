   ...
   class aStream
   {
      ...
      // insertion of manipulators
         ...
         template<class _char, class _traits>   
          inline aStream& operator<<( std::basic_ostream<_char, _traits>& (*PTR_MANIP) (std::basic_ostream<_char, _traits>&);
//         template<class _char, class _traits>
//            std::basic_ostream<_char, _traits>& (*PTR_MANIP) (std::basic_ostream<_char, _traits>&);
//         inline aStream& operator<<(PTR_MANIP);
...
//            inline aStream& operator<<(std::basic_ostream<_char, _traits>& (*ptr_manipulator) std::basic_ostream<_char, _traits>&));
         inline aStream& operator<<(std::basic_ios<char, std::char_traits<char> >& (*ptr_manipulator)(std::basic_ios<char, std::char_traits<char> >&));
...
#else
#  if defined(__sgi)
   aStream& aStream::operator<<(std::basic_ostream<char, std::char_traits<char> >& (*ptr_manipulator)(std::basic_ostream<char, std::char_traits<char> >&))
   {
      if ( ptr_manipulator == std::ends<char, std::char_traits<char> > )
      {
         *pv_ptr_oss << std::ends;
         pv_value = pv_ptr_oss->str();
         delete pv_ptr_oss;
   ...
   aStream& aStream::operator<<(std::basic_ios<char, std::char_traits<char> >& (*ptr_manipulator)(std::basic_ios<char, std::char_traits<char> >&))
   {
      pv_string_terminated = false;
      *pv_ptr_oss << ptr_manipulator;  return *this;
   }
