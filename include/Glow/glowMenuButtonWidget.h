...
class GLOW_EXTERN GlowPopupMenuWidget;
class GLOW_EXTERN GlowPopupMenuMessage;
class GLOW_EXTERN GlowMenuButtonParams;
class GLOW_EXTERN GlowPopupMenuParams;
class GLOW_EXTERN GlowLabeledPopupMenuParams;
typedef TReceiver<const GlowPopupMenuMessage&> GlowPopupMenuReceiver;


class GLOW_EXTERN Glow_MenuButtonSubwindow;
class GLOW_EXTERN Glow_PopupMenuSubwindow;
class GLOW_EXTERN Glow_PopupMenuInternalReceiver;
...
class GLOW_EXTERN GlowMenuButtonWidget :
	public GlowWidget
{
	//-------------------------------------------------------------------------
	//	Public interface
...
class GLOW_EXTERN GlowLabeledPopupMenuWidget :
