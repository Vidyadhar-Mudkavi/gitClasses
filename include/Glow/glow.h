...
class GLOW_EXTERN Glow;
class GLOW_EXTERN GlowComponent;
class GLOW_EXTERN GlowSubwindow;
class GLOW_EXTERN GlowWindow;
class GLOW_EXTERN GlowMenu;
class GLOW_EXTERN GlowSubwindowParams;
class GLOW_EXTERN GlowWindowParams;
class GLOW_EXTERN GlowKeyboardData;
class GLOW_EXTERN GlowMouseData;
class GLOW_EXTERN GlowKeyboardFilter;
class GLOW_EXTERN GlowMouseFilter;
...
class GLOW_EXTERN GlowIdleMessage
{
	friend class Glow;
...
class GLOW_EXTERN GlowTimerMessage
{
	friend class Glow;
...
class GLOW_EXTERN Glow_IdleFuncReceiver;
...
class GLOW_EXTERN GlowMenuMessage
{
	public:
...
class GLOW_EXTERN Glow_MenuItem
{
	friend class GlowMenu;
