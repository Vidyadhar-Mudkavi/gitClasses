...
class GLOW_EXTERN GlowScrollBarWidget;
class GLOW_EXTERN Glow_ScrollBarTimerFunc;
class GLOW_EXTERN GlowScrollBarParams;
class GLOW_EXTERN GlowScrollBarMessage;
