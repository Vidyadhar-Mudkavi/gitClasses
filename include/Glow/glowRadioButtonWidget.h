...
class GLOW_EXTERN GlowRadioButtonWidget;
class GLOW_EXTERN GlowRadioGroupWidget;
class GLOW_EXTERN GlowRadioButtonMessage;
class GLOW_EXTERN GlowRadioButtonParams;
class GLOW_EXTERN GlowRadioGroupParams;
