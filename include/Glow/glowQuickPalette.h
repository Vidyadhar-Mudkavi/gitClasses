...
class GLOW_EXTERN GlowQuickPalette;
class GLOW_EXTERN GlowQuickPanelWidget;
class GLOW_EXTERN GlowQuickRadioGroupWidget;
...
class GLOW_EXTERN GlowQuickPaletteWindow :
	public GlowQuickPalette,
...
class GLOW_EXTERN GlowQuickPaletteSubwindow :
	public GlowQuickPalette,
