...
/** define the following for Microsoft C++ **/
/** defines added by pl and vm. September 8, 2000 **/
#ifdef _MSC_VER
#  define GLOW_COMPAT_NOTEMPLATESPECIALIZATIONS
#  define GLOW_COMPAT_CLIBNOSTDNAMESPACE
#  define GLOW_COMPAT_BADFORSCOPING
#  define GLOW_COMPAT_NOSTDMINMAX
#  define NOMINMAX
#  define GLOW_OPTION_DLLEXPORTS                // this is to help build dll
#  define GLOW_OPTION_DLLIMPORTS                // this is to help use dll
#endif
