...
inline const GLOW_EXTERN Vec3f operator*(
	GLfloat op1,
	const Vec3f& op2);
...
inline GLOW_STD::ostream& GLOW_EXTERN operator<<(
	GLOW_STD::ostream& stream,
	const Vec3f& v);

GLOW_STD::istream& GLOW_EXTERN operator>>(
	GLOW_STD::istream& stream,
	Vec3f& v);
...
const Mat4f GLOW_EXTERN operator*(
	GLfloat op1,
	const Mat4f& op2);
...
GLOW_STD::ostream& GLOW_EXTERN operator<<(
	GLOW_STD::ostream& stream,
	const Mat4f& m);
...
inline const GLOW_EXTERN Quatf operator*(
	GLfloat op1,
	const Quatf& op2);
