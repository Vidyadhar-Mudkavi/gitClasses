...
class GLOW_EXTERN Sender_Base;
class GLOW_EXTERN Receiver_Base;
template <class T> class GLOW_EXTERN TSender;
template <class T> class GLOW_EXTERN TReceiver;
...
class GLOW_EXTERN ReceiverTracker :
	public Sender_Base
{
	//-------------------------------------------------------------------------
	//	Public interface
...
class GLOW_EXTERN TReceiver_Void :
	public Receiver_Base
{
...
template<>
class GLOW_EXTERN TReceiver<void> :
	public Receiver_Base
{
...
class GLOW_EXTERN TSender_Void :
	public Sender_Base
{
...
template<>
class GLOW_EXTERN TSender<void> :
	public Sender_Base
{
