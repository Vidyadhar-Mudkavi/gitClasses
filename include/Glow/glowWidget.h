...
class GLOW_EXTERN GlowWidgetRoot;
class GLOW_EXTERN GlowWidget;
...
class GLOW_EXTERN GlowWidgetParams
{
	public:
...
class GLOW_EXTERN GlowWidgetSubwindowParams :
...
class GLOW_EXTERN GlowWidgetWindowParams :
...
class GLOW_EXTERN Glow_OldWidgetState
{
...
class GLOW_EXTERN GlowWidgetKeyboardData;
class GLOW_EXTERN GlowWidgetKeyboardFilter;
...
class GLOW_EXTERN GlowWidgetTabFilter :
...
class GLOW_EXTERN GlowWidgetSubwindow :
...
class GLOW_EXTERN GlowWidgetWindow :
	public GlowWindow,
	public GlowWidgetRoot
{
	//-------------------------------------------------------------------------
...
class GLOW_EXTERN GlowFixedSizeWidgetWindow :
...
class GLOW_EXTERN GlowSubwindowInWidget :
	public GlowSubwindow
{
	//-------------------------------------------------------------------------
	//	Public interface
