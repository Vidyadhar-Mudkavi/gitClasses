...
class GLOW_EXTERN GlowTextFieldParams;
class GLOW_EXTERN GlowLabeledTextFieldParams;
class GLOW_EXTERN GlowTextFieldWidget;
...
class GLOW_EXTERN Glow_TextField_BlinkTask :
...
class GLOW_EXTERN GlowHiddenTextFieldWidget :
...
class GLOW_EXTERN GlowLabeledTextFieldWidget :
	public GlowTextFieldWidget,
...
class GLOW_EXTERN GlowLabeledHiddenTextFieldWidget :
