...
class GLOW_EXTERN GlowWindowSetting
{
	//-------------------------------------------------------------------------
	//	Public interface
	//-------------------------------------------------------------------------
...
class GLOW_EXTERN GlowDeferredTask :
...
class GLOW_EXTERN GlowFixedSizeWindow :
	public GlowWindow
{
	//-------------------------------------------------------------------------
	//	Public interface
...
class GLOW_EXTERN  GlowReceiverTrackerComponent :
