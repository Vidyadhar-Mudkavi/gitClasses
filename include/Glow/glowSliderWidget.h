...
class GLOW_EXTERN GlowSliderWidget;
class GLOW_EXTERN GlowSliderParams;
class GLOW_EXTERN GlowLabeledSliderParams;
class GLOW_EXTERN GlowSliderMessage;
...
class GLOW_EXTERN GlowLabeledSliderWidget :
