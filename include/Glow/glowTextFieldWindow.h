...
class GLOW_EXTERN GlowLabelWidget;
class GLOW_EXTERN GlowTextFieldWidget;
class GLOW_EXTERN GlowPushButtonWidget;
class GLOW_EXTERN GlowTextFieldWindow;
class GLOW_EXTERN GlowWidgetMapToPushButtonFilter;
...
class GLOW_EXTERN GlowTextFieldWindowMessage
{
	public:
...
class GLOW_EXTERN GlowTextFieldWindowParams
{
	public:
